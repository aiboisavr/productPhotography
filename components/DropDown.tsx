...
import { roomType, themeType, resolutionType } from "../utils/dropdownTypes";
...
interface DropDownProps {
  theme: themeType | roomType | resolutionType;
  setTheme: (theme: themeType | roomType | resolutionType) => void;
  themes: themeType[] | roomType[] | resolutionType[];
}
